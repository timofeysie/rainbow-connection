...
# === Display on actual LCD (Raspberry Pi only) ===
def show_on_lcd():
    if is_raspberry_pi():
        disp.LCD_ShowImage(image, 0, 0)
        print("Image displayed on LCD. Press Ctrl+C to exit...")
        try:
            while True:
...
if __name__ == "__main__":
    print("Starting LCD Application...")
    ...
    if is_raspberry_pi():
        ...
        print("Running on laptop - showing LCD simulation")
        show_simulation()
