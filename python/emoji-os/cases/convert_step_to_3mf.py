#!/usr/bin/env python3
"""
FreeCAD script to convert STEP file to 3MF format for Tinkercad.
This script should be run with FreeCAD's Python interpreter.

Usage (if FreeCAD is installed):
    "C:\Program Files\FreeCAD\bin\FreeCAD.exe" -c convert_step_to_3mf.py

Or run from FreeCAD's Python console:
    exec(open('convert_step_to_3mf.py').read())
"""
...
# File paths
input_file = r"C:\Users\timof\repos\timo\rainbow-connection\python\emoji-os\cases\matrix-3-box-modified.step"
output_file = r"C:\Users\timof\repos\timo\rainbow-connection\python\emoji-os\cases\matrix-3.3mf"
...
try:
    ...
    # Export to 3MF
    print(f"Exporting to 3MF: {output_file}")
