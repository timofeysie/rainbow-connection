...
# Crossbone eyes (menu 0, neg 4) — matches Pico crossboneEyes() bitmap (borderless)
...
# Others menu (menu 3) previews from Pico behavior
others_circle_matrix = [
    [' ', ' ', ' ', 'U', 'U', ' ', ' ', ' '],
    [' ', ' ', 'U', ' ', ' ', 'U', ' ', ' '],
    [' ', 'U', ' ', ' ', ' ', ' ', 'U', ' '],
    ['U', ' ', ' ', ' ', ' ', ' ', ' ', 'U'],
...
color_map = {
    ...
    'P': 'purple',
    'C': 'cyan',
    'U': (0, 0, 255),  # Blue (for circle outline)
    'M': 'magenta',
