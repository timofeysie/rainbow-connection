# -*- coding:utf-8 -*-
# Emoji OS Zero v0.3.5 - Enhanced with BLE Controller functionality
import LCD_1in44
import time
import threading
import asyncio
...
# BLE Controller class - simplified to match working controller.py
class BLEController:
...
print("Emoji OS Zero v0.3.5 started with BLE Controller functionality")
