# emoji os pico v0.2.3 - Startup/connection status indicator on display
import glowbit
...
# Status indicator colours (pale white, pale blue, light green)
PALE_WHITE = (80, 80, 80)
PALE_BLUE = (60, 60, 140)
...
# === Startup indicator: pale white 2x2 centre square ===
...
# Now advertising: show pale blue 2x2 centre square
draw_center_indicator(PALE_BLUE)

print("Emoji OS Pico v0.2.3 - Startup/connection status indicator")
