# automatic_watering.py — Raspberry Pi Pico (Plant_io), v1.1.0
#
# Console line format is parsed by sensor-timelapse-script.py on the timelapse Pi:
#   Moisture {pct}%    Pump Time {seconds}s
# Keep this print() format stable, or update parse_watering_line there to match.
