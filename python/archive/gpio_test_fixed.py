# -*- coding:utf-8 -*-
# gpio_test_fixed.py - GPIO test with the CORRECT sequence
...
print("Starting GPIO test - CORRECTED sequence...")

try:
    # CORRECT sequence: setmode -> cleanup -> setmode again
    print("Test 1: GPIO setup with CORRECT sequence")
...
print("\n🎉 ALL TESTS PASSED!")
print("The issue was: GPIO.cleanup() resets the mode, so we need setmode() again!")
